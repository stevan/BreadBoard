...
inverted the control of the application flow and releived your
...
the destruction of you objects to the garbage collector. With
...
to handle the resolution of said services's dependency relationships.
...
BlockInjection is by far the most versitile type. It simply
...
you to call setters to initailize it. Here is a fairly contrived
...
'db_conn' and 'logger' service respecitively. And as is shown
...
=head2 Why/How do I use this?

Hopefully the above has helped to introduce you the concepts in
Bread::Board and how you go about constructing containers and
services. What we really haven't explained though is why you
would want to do this and how you go about using this in your
application.
